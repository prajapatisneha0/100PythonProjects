...
choice1 = input(' You\'re at a cross road .'
                ' Where do you want to go ?Type Right" or "Left"').lower()
if choice1 =="left":
    choice2 = input('You\'ve  come to a lake .'
          ' There is an island in the middle of the lake .'
          'Type "wait" to wait foe a boat .'
    ...
    if choice2 == "wait":
        ...
        if choice3 == "yellow":
            ...
            print(" you enter a room full or fire . Gme Over .")
        elif choice3 == " red ":
            print(" you enter in the room of beast. Game over . ")
        else:
